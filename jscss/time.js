function showTime() { 
	...
	var startDate = new Date(2018, 4, 05);
	...
	var currentTimeString = "天天:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----小盗  2018-05-20</c>"; 
