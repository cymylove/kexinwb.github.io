function showTime() { 
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "伊伊:<br>"
		+ "We have been in love with you for:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----小盗  2019-05-20</c>"; 
